...
public class IddleBuffState : IdleState
{
    public IddleBuffState(Enemy enemy, Player player, Animator animator) : base(enemy, player, animator) { }
    ...
    public override void Update()
    {
        ...
        else
        {
            ...
            {
                nextState = new WanderBuffState(_enemy, _player, _animator);
                _stage = EVENT.EXIT;
            }
